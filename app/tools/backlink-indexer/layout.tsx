...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://www.developers.com/tools/backlink-indexer",
    ...
    images: [
      {
        url: "https://www.developers.com/og/backlink-indexer.png",
        width: 1200,
        height: 630,
  ...
  alternates: {
    canonical: "https://www.developers.com/tools/backlink-indexer",
  },
  category: "technology",
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            operatingSystem: "Web",
            url: "https://wwww.developers.com/tools/backlink-indexer",
            description:
