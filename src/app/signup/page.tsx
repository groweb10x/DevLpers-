      ...
      <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ color: 'var(--muted)', fontSize: '0.83rem' }}>
                      Showcase skills, get hired, earn money
                    </div>
                  </div>
              ...
              <div onClick={() => setRole('buyer')} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ color: 'var(--muted)', fontSize: '0.83rem' }}>
                      Hire top developers, build faster
                    </div>
                  </div>
                  <div style={{ marginLeft: 'auto' }}>
                    <div style={{
        ...
        {step === 2 && (
          <>
            ...
            <button style={{
              width: '100%', padding: '14px',
              background: role === 'developer' ? 'var(--accent)' : 'var(--accent2)',
              border: 'none', borderRadius: '10px',
              color: '#fff', fontFamily: 'Syne',
              fontWeight: 600, fontSize: '1rem', cursor: 'pointer',
            }}>
              Create {role === 'developer' ? 'Developer' : 'Buyer'} Account
            </button>
